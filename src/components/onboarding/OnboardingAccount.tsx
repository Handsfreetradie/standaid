...
const OnboardingAccount = ({ onNext, onBack, onSignIn }: Props) => {
  ...
  return (
    <div className="min-h-screen bg-background px-5 py-6 overflow-y-auto">
      ...
      <Card className="max-w-sm mx-auto p-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          <Input
            ...
            className="h-[52px] rounded-xl border-foreground/20 focus:border-primary"
            required
          />
          <Input
            type="email"
        ...
        <div className="space-y-3">
          <Button
            type="button"
            variant="outline"
            className="w-full h-12 rounded-xl font-semibold bg-foreground text-background hover:bg-foreground/90 border-0"
          >
             Sign in with Apple
          </Button>
          <Button
