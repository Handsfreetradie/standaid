...
const BottomNav = () => {
  ...
  return (
    <nav className="md:hidden flex-shrink-0 z-50 border-t border-border bg-white overflow-hidden w-full" style={{ paddingBottom: 'max(12px, env(safe-area-inset-bottom))' }}>
