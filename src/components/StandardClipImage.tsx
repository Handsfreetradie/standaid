  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // RenderingCancelledException is the expected result of unmounting
        // mid-render (sending another question while an image loads).
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
