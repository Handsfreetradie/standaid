...
export const C1_LOAD_GROUPS: LoadGroupDef[] = [
  ...
  },
  {
    ...
    rule: "10 A for each 15 A socket-outlet",
    calc: (count) => count * 10,
    hint: "e.g. caravan outlet, some workshop machines.",
  },
  {
    key: "cooking",
    label: "Cooking appliances (range / oven / cooktop)",
    group: "C",
    inputKind: "amps",
    inputLabel: "Total connected current (A)",
    rule: "50% of the connected load",
    calc: (amps) => amps * 0.5,
    hint: "Add the rated current of all cooking appliances, the tool takes 50%.",
  },
  {
    key: "heatingAircon",
